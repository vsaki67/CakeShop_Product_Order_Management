...
public class AllProduct extends javax.swing.JFrame {
    ...
    private void populateInvoiceTable() {
        ...
        for (Product in : productList) {
            Object[] rowData = {in.getCakeId(), in.getName(), in.getDescription(), in.getPrice(), in.getCategory(), in.getQauntity(), in.getExpiaryDate(), in.getUserID()};
    ...
    private void initComponents() {
        ...
        productTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "idCake", "Name", "Description", "Price", "Category", "Qauntity", "Expiary", "userID"
            }
        ));
